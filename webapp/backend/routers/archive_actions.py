...
def add_setup_manually(payload: ManualSetupIn, db: Session = Depends(get_db)):
    ...
    row = SetupArchive(
        ...
        lps_swing_type=result.get("lps_swing_type"),
        lps_anchor_bar=result.get("lps_anchor_bar"),
        lps_anchor_date=result.get("lps_anchor_date"),
        lps_low_bar=result.get("lps_low_bar"),
        ...
        last_supper_pullback_from_extension_pct=result.get("last_supper_pullback_from_extension_pct"),
        last_supper_source_box_age=result.get("last_supper_source_box_age"),
        last_supper_reclaim_quality=result.get("last_supper_reclaim_quality"),
