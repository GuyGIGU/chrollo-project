...
domains/market_data/watchlist_candles.py. Engine-read material never rides this wire
...
from domains.calibration.validation import TICKER_RE
from app.dependencies import require_same_app
from domains.watchlist.router import valid_symbol
from domains.market_data import watchlist_candles as watchlist_candles
