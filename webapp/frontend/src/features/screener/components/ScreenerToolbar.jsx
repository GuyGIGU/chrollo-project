import { TagLegend } from '../../../shared/setup/SetupTags';
import { TAG_CATALOG } from '../../../shared/setup/tagCatalog';
...
const downloadButtonStyle = (disabled, status, severity) => {
  ...
  return {
    ...
    // (5.99 / 5.31 / 8.62 / 8.88). Pinned by app/appearance/inkContrast.test.js.
    color: disabled ? 'var(--text-muted)' : 'var(--myth-ink)',
