...
// trigger groups empty. It lives here, beside the vocabulary that consumes it,
// because an unloaded WATCHLIST yields an empty ticker set indistinguishable
// from a genuinely empty one — the trap finding 9 was about. `useLivePrices`
// owns the polling; this owns the verdict.
