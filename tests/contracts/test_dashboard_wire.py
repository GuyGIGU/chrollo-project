...
The scorer tripwire (tests/scoring/test_scoring.py::test_score_setup_emits_no_v2_keys)
...
tests/market_data/test_fetch_repair.py) — never a booted server. The sector-ETF lookup is
