...
exactly as tests/contracts/test_dashboard_wire.py drives it) and the watchlist candle
...
tests/engine/test_htf.py and tests/backend/test_candles_router.py.
"""
...
def _scan_row(ticker: str) -> dict:
    ...
    tests/contracts/test_dashboard_wire.py mold)."""
    return {
