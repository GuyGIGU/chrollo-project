...
from core.pipeline.market_data.cache import _cache_paths, _read_meta, _weekly_refresh_due, _write_meta
...
from core.pipeline.market_data.fetch_health import load_quarantine, split_active
from core.pipeline.universe.ticker_admission import load_admission, split_downloadable
...
def compute_market_data_health(
    ...
    *,
    ...
    from core.pipeline.market_data.downloads import _meta_regime_mismatch, _price_regime  # noqa: PLC0415 — lazy, yfinance-heavy module
    ...
    if cache_last_session is not None:
        from core.pipeline.market_data.market_calendar import session_gap  # noqa: PLC0415 — lazy, mirrors expected_session above
        from core.pipeline.market_data.downloads import absent_sessions  # noqa: PLC0415 — lazy, yfinance-heavy module
