...
from core.pipeline.market_data.downloads import repair_latest_session_cache
...
def _fresh_result_subset(
    ...
    """
    from core.pipeline.market_data.data_freshness import symbols_missing_closes_on
...
def _clear_absent_session_ledger(meta_file: str) -> None:
    ...
    """
    from core.pipeline.market_data.downloads import ABSENT_SESSIONS_KEY  # noqa: PLC0415 — lazy, yfinance-heavy module
    try:
