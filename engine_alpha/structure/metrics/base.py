...
from engine_alpha.structure.metrics.pivots import (_collapse_swings, _find_pivots,
                                           _pivot_order, _swing_skeleton)

# L2 Wyckoff event reader — relocated to engine_alpha.structure.events.box_events. Re-exported
# here so every existing ``from engine_alpha.structure.metrics.base import ...`` site keeps
...
from engine_alpha.structure.events.box_events import (  # noqa: F401  (re-export for import compatibility)
    _DETECT,
