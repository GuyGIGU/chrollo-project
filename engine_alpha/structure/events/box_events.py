...
Relocated verbatim out of ``engine_alpha.structure.metrics.base`` (a pure module peel; no
...
``engine_alpha.structure.metrics.base``, so every existing ``from engine_alpha.structure.metrics.base
...
from engine_alpha.structure.metrics.pivots import _build_zigzag, _collapse_swings, _find_pivots
...
def _staircase_from_pivots(peaks, valleys, highs, lows, R, S, atr_val, min_amp):
    ...
    Event Map's windowed views (``engine_alpha.structure.events.event_map``, which filter ONE
    ...
    from engine_alpha.structure.events.market_structure import label_market_structure
...
def read_box_staircase(base_df, R, S, atr_val, *, noise_frac=None):
    ...
    return _staircase_from_pivots(peaks, valleys, highs, lows, R, S, atr_val, min_amp)
