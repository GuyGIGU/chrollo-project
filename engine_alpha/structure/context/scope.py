...
from engine_alpha.structure.phases.phase_d import drawn_lps_zone_start, resolve_phase_d_boundary
...
def _resolve_phase_d_start(*, box_start: int, base_len: int, last: int,
    ...
    Compatibility wrapper around ``engine_alpha.structure.phases.phase_d`` so existing tests and
...
def scope_consolidation(
    ...
    *,
    ...
    # Boundary rule lives in engine_alpha.structure.phases.phase_d: use the best right-side
