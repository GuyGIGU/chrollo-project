...
Usage (ChrolloDashboard venv python, from repo root):
    python -m tools.research.ta_grade_archive_replay                    # full archive
    python -m tools.research.ta_grade_archive_replay --since 2026-07-01
    python -m tools.research.ta_grade_archive_replay --scan-date 2026-08-08
    python -m tools.research.ta_grade_archive_replay --limit 50         # smoke
    python -m tools.research.ta_grade_archive_replay --json output/ta_grade_archive_replay.json
"""
...
try:  # works under both `python -m tools.research.ta_grade_archive_replay` and `python tools/research/ta_grade_archive_replay.py`
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m tools.research.ta_grade_archive_replay")
