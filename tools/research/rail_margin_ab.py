...
Usage (ChrolloDashboard venv python, from repo root):
    python -m tools.research.rail_margin_ab             # the full pre-registered grid
    python -m tools.research.rail_margin_ab --json OUT  # also dump results
"""
...
try:  # works under both `python -m tools.research.rail_margin_ab` and `python tools/research/rail_margin_ab.py`
...
def main() -> None:
    ...
    for name, overrides, predicted in VARIANTS:
        ...
        print(f"  mechanical A/B/E: "
              ...
              "   (C/D from tools.research.rail_margin_evidence at this value)")
