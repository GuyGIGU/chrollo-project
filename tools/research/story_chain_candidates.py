...
two-installs trap).
    ...
    python -m tools.research.story_chain_candidates --out output/story_chain_candidates.json
    python -m tools.research.story_chain_candidates --tickers MAN FTNT --out ...   # bounded debug
"""
...
try:  # works under both `python -m tools.research.story_chain_candidates` and `python tools/research/story_chain_candidates.py`
