...
2026-08-14) is read on the ungated frame for its trend structure ONLY, and says so.
    ...
    python -m tools.research.operator_marks_diff --marks docs/trend_end_marks_2026-08.json
"""
...
try:  # works under both `python -m tools.research.operator_marks_diff` and `python tools/research/operator_marks_diff.py`
...
from tools.calibration.marks_json import load_marks_json, marks_json_fingerprint
