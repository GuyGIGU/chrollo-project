...
Usage (ChrolloDashboard venv python, from repo root):
    python -m tools.research.rail_margin_evidence            # print the evidence report
    python -m tools.research.rail_margin_evidence --json OUT # also dump rows to JSON
"""
...
try:  # works under both `python -m tools.research.rail_margin_evidence` and `python tools/research/rail_margin_evidence.py`
