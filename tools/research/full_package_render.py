...
stays byte-identical.
    ...
    python -m tools.research.full_package_render AGCO TFX PH        # render these tickers
    python -m tools.research.full_package_render AGCO --window 0    # show the whole 2y frame
    python -m tools.research.full_package_render PH --no-events     # drop the L2 zone context
    python -m tools.research.full_package_render TOL --cache "C:/.../market_data_cache_5y.parquet"
"""
...
try:  # works under both `python -m tools.research.full_package_render` and `python tools/research/full_package_render.py`
...
from tools.research.operator_marks_diff import _prep_live

_OUT_DIR = os.path.join(_ROOT, "research", "fidelity", "full_package")
