...
Usage (ChrolloDashboard venv python, from repo root):
    python -m tools.audits.ta_grade_timing
"""
...
try:  # works under both `python -m tools.audits.ta_grade_timing` and `python tools/audits/ta_grade_timing.py`
...
from tools.regression import shadow_diff                                  # noqa: E402
