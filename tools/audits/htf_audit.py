...
TradingView chart. This is the calibration instrument for the HTF window presets.
    ...
    python -m tools.audits.htf_audit NVDA AAPL AMD            # today
    python -m tools.audits.htf_audit NVDA --as-of 2026-03-30  # historical
    python -m tools.audits.htf_audit NVDA --cache market_data_cache_5y.parquet
"""
...
try:  # works under both `python -m tools.audits.htf_audit` and `python tools/audits/htf_audit.py`
