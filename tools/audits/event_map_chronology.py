...
like ``tools.regression.marks_corpus --check``, not part of the default suite.

Usage:
    python -m tools.audits.event_map_chronology            # report
    python -m tools.audits.event_map_chronology --check    # exit 1 on any violation
"""
...
try:  # works under both `python -m tools.audits.event_map_chronology` and `python tools/audits/event_map_chronology.py`
