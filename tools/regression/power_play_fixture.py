...
reason; do not point any other tool at these paths.
    ...
    python -m tools.regression.power_play_fixture --build [--cache PATH]
"""
...
try:  # works under both `python -m tools.regression.power_play_fixture` and `python tools/regression/power_play_fixture.py`
