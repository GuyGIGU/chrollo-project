...
docs/power_play_program_2026-08.md ("The ruling loop").
    ...
    python -m tools.power_play_census --plan                    # print the pricing plan only
    python -m tools.power_play_census --out output/pp_census.json
    python -m tools.power_play_census --cache "..\\Chrollo Project\\market_data_cache_5y.parquet" --out ...
    python -m tools.power_play_census --tickers MAN FTNT --out ...   # bounded debug run
"""
...
from tools.calibration_harness import parse_variant          # noqa: E402
from tools.marks_json import (                               # noqa: E402
    load_marks_json,
    marks_json_fingerprint,
)
from tools.replay import prepared_frame_with_reason, read_structure_under  # noqa: E402
