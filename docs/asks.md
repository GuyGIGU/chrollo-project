...
| 2026-08-22 | **Redeploy + log rotation**: `update_dashboard.bat` (the retirement + fixes go live), and the elevated `nssm set ChrolloDashboard AppRotate…` block — the error log regrew to 173.8 MB in 2 days (~87 MB/day of INFO chatter on stderr); without rotation the 245 MB returns weekly. | Live dashboard + disk | decisions.md 2026-08-20 row (the AppRotate note) |
