...
| **SOS** | the advance *through* resistance — a genuine breakout that opens Phase D | a typed R-rail **wave** that HELD near R with a genuine mini-consolidation — **a breach of R is NOT required** (operator ruled 2026-08-26; the per-event `breached` bit records whether the top cleared R + the ATR buffer, as data) | "make SOS require the breakout" reads like a one-line canon fix; measured 2026-08-26 (sweep P2-7): 58 of 96 live SOS events and 29 of 52 story anchors would flip — the operator ruled the held high test IS the strength. Re-proposing costs a fresh A/B against the decisions.md census |
